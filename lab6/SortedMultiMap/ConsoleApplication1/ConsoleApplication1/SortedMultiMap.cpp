...
//WC: Th(h)+Th(values.length), to find the last element for the lowest node
...
//BC: TH(1), one example would be a degenerated tree on the right when removingthe root
...
ValueIterator SortedMultiMap::viterator(TKey k) const
{
